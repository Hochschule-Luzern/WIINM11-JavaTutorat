package ch.softwareexperts.java.collection.hashMap;
import java.util.*;
...
public class UseHashMap {
    ...
    public static String possibleKeys(HashMap<String, String> h, String actual_value){
      
    	// ab hier: ihr Code
    	
	  return "String_mit_allen_möglichen_Schlüsseln";  // ...zu ändern!
	}
}